...
- [martinsione/dotfiles](https://github.com/martinsione/dotfiles) - My configs. Neovim config is what you are probably looking for!
...
- [ptdewey/pendulum-nvim](https://github.com/ptdewey/pendulum-nvim) - Track time spent coding in Neovim
...
- [swzzl-com/the-solar-system](https://github.com/swzzl-com/the-solar-system) - :lollipop: Superbook: The Solar System by Marvin Danig. Read here →
...
- [KingMichaelPark/age.nvim](https://github.com/KingMichaelPark/age.nvim) - A simply utility for loading encrypted secrets from an age encrypted file.
...
- [sschleemilch/slimline.nvim](https://github.com/sschleemilch/slimline.nvim) - A minimal neovim statusline
...
- [askfiy/http-client.nvim](https://github.com/askfiy/http-client.nvim) - http-client.nvim is a Neovim plugin designed to help users quickly and easily send HTTP requests directly from within Neovim.  The plugin supports multiple request formats and file uploads, offering d
...
- [christopher-francisco/tmux-status.nvim](https://github.com/christopher-francisco/tmux-status.nvim) - Get tmux status components for your statusline
...
- [heygarrett/.config](https://github.com/heygarrett/.config) - mirror of repo on Codeberg
...
- [mthbernardes/codeexplain.nvim](https://github.com/mthbernardes/codeexplain.nvim) - A nvim plugin Powered by GPT4ALL for Real-time Code Explanation and Vulnerability Detection (no internet necessary)
...
- [swyxio/swyxio](https://github.com/swyxio/swyxio) - readmeee
...
- [angular-slider/ngx-slider](https://github.com/angular-slider/ngx-slider) - Self-contained, mobile friendly slider component for Angular based on angularjs-slider
